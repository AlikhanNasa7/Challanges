...
export default function WelcomePage() {
  ...
  const yCity = useTransform(scrollY, [0,200,350,500], [0,50,100,150]);
  const opacityCity = useTransform(scrollY, [0,200,250,500], [1,0.75,0.5,0]);

  const yHero = useTransform(scrollY, [0,200,350,500], [0,100,150,250]);
  const opacityHero = useTransform(scrollY, [0,200,350,500], [1,0.75,0.5,0]);

  const yText = useTransform(scrollY, [0,200,350,500], [0,175,300,400]);
  const scaleText = useTransform(scrollY, [0,300,500], [1, 1.25, 1.5]);
